...
export default function Home(){
  ...
  const slides = [
    ...
    {
      img: "https://wallpapercave.com/dwp1x/wp1828955.jpg",
      label: "Second Slide",
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
    },
    {
      img: "https://storecms.blob.core.windows.net/uploads/51b69245-62b1-4889-af1f-1a498bd995ca-young-man-coding.jpg",
      label: "Third Slide",
      description:
